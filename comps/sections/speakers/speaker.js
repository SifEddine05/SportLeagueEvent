...
const Speaker = ({name,description,image}) => {
    ...
    return ( 
        <label className="h-fit overflow-hidden swap swap-rotate group ">
            <input type="checkbox" />
             <div  data-tip="click to see detail" className="tooltip swap-off fill-current shadow-lg items-center rounded-lg mx-auto  groupe-hover:p-0 hover:cursor-pointer border-2 lg:w-[200px] md:w-[300px] w-[200px]  border-cyan-800 p-2 self-center">
