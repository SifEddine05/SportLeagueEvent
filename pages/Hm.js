...
function Hm(props) {
    return (
        ...
        <div className="w-screen  flex flex-col items-center">
            <div className="flex flex-col w-full md:h-full h-[280px] sm:h-[320px] justify-center items-center bg-red-00 bg-[#EFF7FB] pt-[12%] ">
              <div className="rounded-tl-[48px] rounded-tr-[48px] rounded-br-[200px] lg:rounded-br-[300px] rounded-bl-[48px] w-[80%] lg:max-h-[600px] lg:h-[65%] h-[300px] bg-[#1E96FC] flex flex-col overflow-auto">
